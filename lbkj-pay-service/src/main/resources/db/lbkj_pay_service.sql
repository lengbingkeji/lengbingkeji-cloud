CREATE database if NOT EXISTS `lbkj_pay_service` default character set utf8mb4 collate utf8mb4_general_ci;
USE `lbkj_pay_service`;
...
CREATE TABLE IF NOT EXISTS `pay_order` (
    ...
    ) ENGINE = InnoDB CHARACTER SET = utf8mb4 COLLATE = utf8mb4_general_ci ROW_FORMAT = Dynamic COMMENT='支付订单';

-- 正在导出表  pay_order 的数据：~0 rows (大约)
